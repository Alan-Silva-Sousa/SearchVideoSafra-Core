...
export class AudioController {
  ...
  @Get()
  @Audited({ action: 'RECORDING_SEARCH', mediaKind: 'video' })
  @ApiOperation({
  ...
  @Get('download/:id')
  @Audited({ action: 'MEDIA_DOWNLOAD', mediaKind: 'video' })
  @ApiOperation({
  ...
  @Get('play/:id')
  @Audited({ action: 'VIDEO_PLAY', mediaKind: 'video' })
  @ApiOperation({
  ...
  @Get(':id')
  @Audited({ action: 'RECORDING_DETAILS_VIEW', mediaKind: 'video' })
  @ApiOperation({
  ...
  @Post('zip')
  @Audited({ action: 'ZIP_DOWNLOAD', mediaKind: 'video' })
  @HttpCode(200)
  @ApiOperation({
